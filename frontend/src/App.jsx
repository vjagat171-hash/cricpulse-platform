...
import LiveMatches from './components/LiveMatches'; // <-- Yeh line add ki gayi hai
        ...
        <div className="min-h-screen bg-gray-900 text-white p-6 font-sans">
            ...
            <header className="flex justify-between items-center mb-8 border-b border-gray-700 pb-4">
                <h1 className="text-3xl font-extrabold text-blue-500 tracking-wider">
                    CricPulse <span className="text-sm font-normal text-gray-400">Pro</span>
                </h1>
            ...
            <main className="max-w-6xl mx-auto space-y-10">
                ...
                {/* 1. WebSocket Live Arena (Top Section) */}
                {!matchData ? (
                    <div className="flex h-40 items-center justify-center bg-gray-800 rounded-2xl border border-gray-700">
                        <span className="text-2xl font-bold animate-pulse text-gray-400">Loading Live Arena...</span>
                    </div>
                ) : (
                        ...
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <div className="w-1/3 text-center">
                                ...
                                <p className="mt-4 text-sm text-gray-400">
                                    Last Ball: <span className="font-bold text-white bg-gray-600 px-2 py-1 rounded">{matchData.lastBall}</span>
                                </p>
                            </div>
                            <div className="text-center w-1/3">
                ...
                {/* 2. REST API Matches List (Bottom Section) */}
                <div className="bg-gray-800 rounded-2xl shadow-2xl p-6 border border-gray-700">
                    <LiveMatches />
                </div>
